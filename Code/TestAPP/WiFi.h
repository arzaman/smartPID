...
#define WIFI_OWN_SSID	"SPC1000_xxxxxxxx"
...
public:
	 ...
	 * - pwd: password of the access point (if NULL or empty, no Wi-Fi security
	 *        is used, otherwise connections are protected with WPA/WPA2)
	 * Returns: none
	 */
	void configAP(const char *ssid, const char *pwd);
