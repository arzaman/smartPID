...
After downloading, copy down the location of the arzaman.inf file
...
Paste the directory location of your arzaman.inf files into the search location. Then hit "Next".

Click "Install" when the next pop-up questions if you want to install the driver. If you get any warning for unknown source of the driver please accept.
